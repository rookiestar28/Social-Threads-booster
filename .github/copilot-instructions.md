...
Present research results to the user before drafting. Use `@workspace /search` or Copilot's web search. If web search is not available, list the specific claims that need manual verification by the user.
